...
namespace PhilLibX.Compression
{
    public static unsafe class ZLIB
    {
        ...
        public static int CompressBound(int size) => NativeMethods.MZ_deflateBound(IntPtr.Zero, size);
        ...
        public static byte[] Decompress(byte[] inputBuffer, int outputSize) => Decompress(inputBuffer, outputSize, true);
        ...
        public static byte[] Decompress(byte[] inputBuffer, int outputSize, bool hasZlibHeader)
        {
            ...
            fixed (byte* a = &inputBuffer[0])
            {
                ...
                {
                    var result = (NativeMethods.MiniZReturnStatus)NativeMethods.MZ_uncompress(
                        b,
                        ref rawBufSize,
                        a,
                        inputBuffer.Length,
                    ...
                    if (result != NativeMethods.MiniZReturnStatus.OK)
        ...
        public static byte[] Compress(byte[] inputBuffer)
        {
            ...
            fixed (byte* a = &inputBuffer[0])
            {
                ...
                fixed (byte* b = &temp[0])
                {
                    var result = (NativeMethods.MiniZReturnStatus)NativeMethods.MZ_compress(
                        b,
