...
namespace PhilLibX.Media3D
{
    ...
    public class Animation : Graphics3DObject
    {
        ...
        /// <summary>
        /// Gets or Sets the morph animation.
        /// </summary>
        public MorphAnimation? MorphAnimation { get; set; }
        ...
        /// Gets the number of skeletal animation targets.
        /// </summary>
        public int MorphTargetCount => MorphAnimation != null ? MorphAnimation.Targets.Count : 0;
