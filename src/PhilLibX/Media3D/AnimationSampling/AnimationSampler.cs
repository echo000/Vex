...
{
    /// <summary>
    /// A class to handle sampling an <see cref="Animation"/> at arbitrary frames or
    /// in a linear fashion.
    /// </summary>
    public class AnimationSampler
    {
        ...
        public AnimationSampler(Animation animation)
        {
            ...
            if (Animation.SkeletonAnimation != null)
            {
                ...
                SkeletonAnimationSampler = new(this, Animation.SkeletonAnimation,
        ...
        public AnimationSampler(Animation animation, Skeleton? skeleton)
        {
            ...
            if (Animation.SkeletonAnimation != null)
            {
                ...
                if (skeleton == null)
                    throw new Exception();
                SkeletonAnimationSampler =
                    new(this, Animation.SkeletonAnimation, skeleton);
            }
        }

        public void
        Update(float time) => Update(time, AnimationSampleType.AbsoluteFrameTime);
        ...
        public AnimationSampler Update(float time, AnimationSampleType type)
        {
            ...
            CurrentWeight =
                AnimationHelper.GetWeight(Weights, time, StartFrame, 1.0f, ref cursor);
